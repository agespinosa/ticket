...
// Returns the private 'App\Repository\CodigoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CodigoRepository.php';

return $this->privates['App\Repository\CodigoRepository'] = new \App\Repository\CodigoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
