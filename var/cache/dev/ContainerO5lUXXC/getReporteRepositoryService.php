...
// Returns the private 'App\Repository\ReporteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ReporteRepository.php';

return $this->privates['App\Repository\ReporteRepository'] = new \App\Repository\ReporteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
