...
// Returns the private 'App\Repository\EstadoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EstadoRepository.php';

return $this->privates['App\Repository\EstadoRepository'] = new \App\Repository\EstadoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
