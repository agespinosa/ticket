...
// Returns the private 'App\Repository\UbicacionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UbicacionRepository.php';

return $this->privates['App\Repository\UbicacionRepository'] = new \App\Repository\UbicacionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
